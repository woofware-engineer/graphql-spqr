...
import static io.leangen.graphql.support.GraphQLTypeAssertions.*;
...
public class GenericsTest {
    ...
    public void testRelayIdGenerics() {
        ...
        String jsonDate = valueMapperFactory.getValueMapper(Collections.emptyMap(), ENVIRONMENT).toString(firstEvent, GenericTypeReflector.annotate(Date.class), GraphQLContext.newContext().build(), Locale.getDefault());
